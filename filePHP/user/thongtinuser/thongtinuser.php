    ...
    <form class="container">
        ...
        <div class="form-group">
            ...
            <div style="display: flex;">
                ...
                <label for="html" style="margin-left: 7px;">Nu</label><br>
                <?php } else { ?>
                <input type="radio" name="Sex" value="Nam">
                <label for="html" style="margin-left: 7px;">Nam</label><br>
                <input type="radio" name="Sex" value="Nu" checked>
                <label for="html" style="margin-left: 7px;">Nu</label><br>
                <?php } ?>
            </div>
            </select>
        ...
        <div class="form-group">
            ...
            <input type="date" name="name" id="name" class="form-control" placeholder="Enter your birthday" required
                value="<?php echo $row1['Birthday'] ?>">
        </div>
        <div class="form-group">
            <label id="name-label" for="name">Phone</label>
            <input type="text" name="name" id="name" class="form-control" placeholder="Enter your phone number" required
                value="<?php echo $row1['Phone'] ?>">
        </div>
        <div class="form-group">
            <label id="name-label" for="name">CMND</label>
            <input type="text" name="name" id="name" class="form-control" placeholder="Enter your CMND" required
                value="<?php echo $row1['CMND'] ?>">
        </div>
        <div class="form-group">
            <label id="name-label" for="name">Địa chỉ</label>
            <input type="text" name="name" id="name" class="form-control" placeholder="Enter your address" required
