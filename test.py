...
from utils.average_plate import tracking, get_average_plate_value
...
myNetwork = NeuralNetwork(modelFile="D:/PBL/ALPR_System/ALPR_System/model/binary_128_0.50_ver3.pb",
                            labelFile="D:/PBL/ALPR_System/ALPR_System/model/binary_128_0.50_labels_ver2.txt")
# myNetwork = cv2.VideoCapture(1)
...
cap = cv2.VideoCapture(1) # video path
# cap = cv2.VideoCapture('test_videos/ccptpm/test.mp4') # video path
